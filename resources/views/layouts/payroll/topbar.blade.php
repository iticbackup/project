<div class="topbar">
    <!-- LOGO -->
    <div class="brand">
        <a href="{{ route('payroll.home') }}" class="logo">
            <span>
                <img src="{{ URL::asset('itic/icon_itic.png') }}" alt="logo-small" class="logo-sm">
            </span>
            <span>
                <img src="{{ URL::asset('itic/text_itic.png') }}" alt="logo-large" class="logo-lg logo-light">
                <span style="font-weight: bold">Payroll</span>
                {{-- <img src="{{ URL::asset('itic/text_itic_dark.png') }}" alt="logo-large" class="logo-lg logo-dark"> --}}
            </span>
        </a>
    </div>
    <!--end logo-->
        ...
        <ul class="list-unstyled topbar-nav float-end mb-0">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="ms-1 nav-user-name hidden-sm">{{ auth()->user()->name }} - {{ auth()->user()->role->roles }}</span>
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    <li class="has-submenu">
                        <a href="{{ route('payroll.home') }}">
                            <span><i data-feather="home" class="align-self-center hori-menu-icon"></i>Dashboard</span>
                        </a>
                    </li>
                    <li class="has-submenu">
                        <a href="#">
                            <span><i data-feather="grid" class="align-self-center hori-menu-icon"></i>Payroll</span>
                        </a>
                        <ul class="submenu">
                            <li>
                                <a href="javascript::void()"><i class="ti ti-minus"></i>Borongan B</a>
                            </li>
                            <li>
                                <a href="javascript::void()"><i class="ti ti-minus"></i>Borongan 20GR</a>
                            </li>
                            <li>
                                <a href="javascript::void()"><i class="ti ti-minus"></i>Harian</a>
                            </li>
                            <li>
                                <a href="javascript::void()"><i class="ti ti-minus"></i>Supit Rit</a>
                            </li>
                            <li>
                                <a href="javascript::void()"><i class="ti ti-minus"></i># Posting Data #</a>
                            </li>
                            {{-- <li class="has-submenu">
                    ...
                    <li class="has-submenu">
                        <a href="#">
                            <span><i data-feather="grid" class="align-self-center hori-menu-icon"></i>Report</span>
                        </a>
                        <ul class="submenu">
                            <li class="has-submenu">
                                <a href="#"><i class="ti ti-minus"></i>Borongan B</a>
                                <ul class="submenu">
                                    <li><a href="apps-email-inbox"><i class="ti ti-minus"></i>Detail Borongan B</a></li>
                                </ul>
                            </li>
                            <li class="has-submenu">
                                <a href="#"><i class="ti ti-minus"></i>Borongan 20GR</a>
                                <ul class="submenu">
                                    <li><a href="apps-email-inbox"><i class="ti ti-minus"></i>Detail Borongan 20GR</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="ti ti-minus"></i>Harian</a>
                            </li>
                            <li>
                                <a href="#"><i class="ti ti-minus"></i>Supir Rit</a>
                            </li>
                            <li>
                                <a href="#"><i class="ti ti-minus"></i>Report All</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-submenu">
                        <a href="#">
                            <span><i data-feather="grid" class="align-self-center hori-menu-icon"></i>Other</span>
                        </a>
                        <ul class="submenu">
                            <li>
                                <a href="#"><i class="ti ti-minus"></i>Revisi (Jika Sudah Terposting)</a>
                            </li>
                        </ul>
                    </li>
                    {{-- <li class="has-submenu">
