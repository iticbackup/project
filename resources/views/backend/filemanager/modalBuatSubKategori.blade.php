<div class="modal fade hide-modal modalBuatSubKategori" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="form-buatSubKategori-simpan" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="buatKategoriFolder" id="buatKategoriFolder" readonly>
                </div>
                <div class="mb-3">
                    <label class="form-label">Upload File</label>
                    <input type="file" id="input-file-now" name="files" class="dropify" />
                    
                    {{-- <input type="text" class="form-control" name="buat_sub_nama_berkas" placeholder="Nama Folder"> --}}
                </div>
