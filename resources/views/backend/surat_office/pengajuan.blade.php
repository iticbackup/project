...
@section('title') Pengajuan | {{ $surat_office->nomor_surat }} @endsection
@section('css')
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form id="upload-pengajuan" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="date" name="pengajuan_tanggal" class="form-control">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                <label for="" class="form-label">Perihal</label>
                                <input type="text" name="pengajuan_perihal" class="form-control" placeholder="Perihal">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <select name="pengajuan_pengguna" class="form-control" id="">
                                    ...
                                    <option value="Direksi-{{ $departemen->departemen->nama_departemen }}">Direksi</option>
...
@section('script')
    ...
    <script>
        $('#upload-pengajuan').submit(function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            // $('#image-input-error').text('');
            $.ajax({
                type:'POST',
                url: "{{ route('surat_office.pengajuan.simpan',['id' => $surat_office->id]) }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
