...
@section('title') Pengajuan Ulang | {{ $surat_office->nomor_surat }} @endsection
@section('css')
...
@section('content')
    ...
    @slot('li_1') Pengajuan Ulang @endslot
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form id="upload-pengajuan-ulang" method="post" enctype="multipart/form-data">
                @csrf
...
@section('script')
    ...
    <script>
        $('#upload-pengajuan-ulang').submit(function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            // $('#image-input-error').text('');
            $.ajax({
                type:'POST',
                url: "{{ route('surat_office.pengajuan_ulang.simpan',['id' => $surat_office->id]) }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
