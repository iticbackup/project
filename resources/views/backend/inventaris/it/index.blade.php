...
@section('content')
    ...
    @include('backend.inventaris.it.modalBuat')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('inventaris.it.download_report') }}" class="btn btn-primary"><i class="fas fa-download"></i> Download Report</a>
...
@section('script')
    ...
    <script>
        ...
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('inventaris.it.simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        function hapus(id) {
            // $.ajax({
            //     type: 'GET',
            //     url: "{{ url('it/inventaris/') }}" + '/' + id + "/delete",
