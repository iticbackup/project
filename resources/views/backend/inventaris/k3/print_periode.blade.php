...
<head>
    ...
    <title>Formulir Checklist Periode {{ $_GET['periode_from'].' - '.$_GET['periode_to'] }}</title>
...
<body>
    ...
    @foreach ($inventarisK3Details as $key => $inventarisK3Detail)
        ...
        @if ($inventarisK3Detail->jenis_barang == 'APAR')
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td colspan="5" rowspan="2" style="width: 450px" class="td text-center text-bold">FORMULIR
            ...
            <?php $data['formApars'] = App\Models\FormApart::where('inventaris_k3_detail_id', $inventarisK3Detail->id)

                                                            ->whereBetween('periode',[$periode_from,$periode_to])

                                                            ->get();

            ?>

            @foreach ($data['formApars'] as $formApar)

                <?php $data['formAparDetails'] = \App\Models\FormApartDetail::where('form_apart_id', $formApar->id)
                ...
                <div style="margin-top: 2.5%">
                    ...
                    <table class="table2">
                        ...
                        <tr>
                            ...
                            <td colspan="3">: {{ $formApar->kode_tabung }}</td>

                            <td class="text-bold">BERAT</td>

                            <td colspan="3">: {{ $formApar->berat }}</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">: {{ $formApar->jenis }}</td>

                            <td class="text-bold">EXPIRED</td>

                            <td colspan="3">: {{ \Carbon\Carbon::create($formApar->expired)->format('d-m-Y') }}</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">: {{ $formApar->warna }}</td>

                            <td class="text-bold">TEMPAT</td>

                            <td colspan="3">: {{ $formApar->tempat }}</td>
                        ...
                        @forelse ($data['formAparDetails'] as $key => $formAparDetail)
                            ...
                            <tr class="tr2">
                                ...
                                @if ($formAparDetail->tanggal)
                                    ...
                                    <td class="text-center td2" style="font-size: 12px; width: 120px">
                                ...
                                <td class="text-center td2">
                                    ...
                                    @if ($formAparDetail->pressure == 'Y')
                                        ...
                                        <img src="{{ URL::asset('public/assets/images/checkmark-outline.png') }}"

                                            alt="logo-small" class="text-center" style="margin: 5%" width="13">

                                    @elseif ($formAparDetail->pressure == 'N')

                                        <img src="{{ URL::asset('public/assets/images/close-outline.png') }}"
                                ...
                                <td class="td2 text-center" style="font-size: 14px;">{{ $explode_approval_apar[0] }}

                                </td>

                                <td class="td2 text-center" style="font-size: 12px;">

                                    {{ $formAparDetail->keterangan }}</td>
        ...
        @elseif($inventarisK3Detail->jenis_barang == 'HYDRANT')
            ...
            <?php $data['formHydrants'] = \App\Models\FormHydrant::where('inventaris_k3_detail_id', $inventarisK3Detail->id)

                                                                ->whereBetween('periode',[$periode_from,$periode_to])

                                                                ->get(); ?>

            @foreach ($data['formHydrants'] as $formHydrants)

                <?php $data['formHydrantDetails'] = \App\Models\FormHydrantDetail::where('form_hydrant_id', $formHydrants->id)
                ...
                <div style="margin-top: 1%">
                    ...
                    <table class="table2">
                        ...
                        @forelse ($data['formHydrantDetails'] as $keys => $formHydrantDetail)
                            ...
                            <tr>
                                    ...
                                    @if ($formHydrantDetail->selang != null)
                                        ...
                                        @if ($selang->besar == 'Y')
                                            ...
                                            <img src="{{ URL::asset('public/assets/images/checkmark-outline.png') }}"
                                                ...
                                                alt="logo-small" class="text-center" style="margin: 5%"
                                ...
                                <td class="td text-center" style="font-size: 14px;">{{ $explode_ttd_hydrant[0] }}

                                </td>

                                <td class="td text-center" style="font-size: 14px;">

                                    {{ $explode_approval_hydrant[0] }}</td>

                                <td class="td text-center" style="font-size: 10px;">

                                    {{ $formHydrantDetail->keterangan }}</td>
