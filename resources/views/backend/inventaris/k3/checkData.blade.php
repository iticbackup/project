                                                                ...
                                                                <td class="text-center" style="width: 5%">
                                                                    @if ($continueDate == $bulan_aktif)
                                                                        @if ($formAparDetail->tanggal != null)
                                                                            {{ \Carbon\Carbon::create($formAparDetail->tanggal)->format('d-m-Y') }}
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    @else
                                                                        @if ($formAparDetail->tanggal)
                                                                            {{ $formAparDetail->tanggal }}
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    @endif
                                                                    ...
                                                                    @if ($continueDate == $bulan_aktif)
                                                                        @if ($formAparDetail->images != null)
                                                                            <div class="modal fade"
                                                                                id="exampleModalCenter1" tabindex="-1"
                                                                                role="dialog"
                                                                ...
                                                                <td class="text-center" style="width: 5%">
                                                                    @if ($continueDate == $bulan_aktif)
                                                                        @if ($formHydrantDetail->tanggal != null)
                                                                            {{ \Carbon\Carbon::create($formHydrantDetail->tanggal)->format('d-m-Y') }}
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    @else
                                                                        @if ($formHydrantDetail->tanggal)
                                                                            {{ $formHydrantDetail->tanggal }}
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    @endif
